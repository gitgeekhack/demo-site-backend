...
class DocumentSummarizer:
    ...
    async def __remove_first_line(self, generated_summary_firstline):
        reference_summary_firstline = 'Based on the provided medical report, here is a summary of the key information:'
        matching_threshold = 60
        return fuzz.token_sort_ratio(reference_summary_firstline, generated_summary_firstline) > matching_threshold
